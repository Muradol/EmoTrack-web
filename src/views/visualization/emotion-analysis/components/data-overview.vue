<template>
  <a-spin :loading="loading" style="width: 100%">
    <a-card
      class="general-card"
      :title="$t('emotionAnalysis.card.title.dataOverview')"
    >
...
<script lang="ts" setup>
  ...
  const renderData = computed(() => [
    {
      title: t('emotionAnalysis.dataOverview.contentProduction'),
      value: 1902,
      prefix: {
        icon: 'icon-edit',
    ...
    {
      title: t('emotionAnalysis.dataOverview.contentClick'),
      value: 2445,
      prefix: {
        icon: 'icon-thumb-up',
    ...
    {
      title: t('emotionAnalysis.dataOverview.contentExposure'),
      value: 3034,
      prefix: {
        icon: 'icon-heart',
    ...
    {
      title: t('emotionAnalysis.dataOverview.activeUsers'),
      value: 1275,
      prefix: {
        icon: 'icon-user',
